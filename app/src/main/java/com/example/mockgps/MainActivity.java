    ...
    public void showLatlngDialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                setPosi(dialog_lng_str,dialog_lat_str);
            }
        });
...
//                updateMapState();
    ...
    protected void onResume() {
        ...
        String data = SharePreferenceUtils.getJingWei(MainActivity.this);
        if(data.length()<5){
            //Toast.makeText(MainActivity.this, "请检查是否激活！", Toast.LENGTH_LONG).show();
            //finish();
        }else {
//            Toast.makeText(MainActivity.this, "正在执行移位操作...", Toast.LENGTH_LONG).show();
